...
def linear_xent_fwd_prep_bwd_kernel_matmul_t(
    ...
    # tl.static_print(V_BLOCK_SIZE, N_BLOCK_SIZE, H_BLOCK_SIZE, GROUP_SIZE, monitoring)
        ...
        with torch.cuda.device(x_in.device.index):  # actually required for devices other than 0
            ...
            with torch.no_grad():
                ...
                if monitoring:
                    ...
                    logit_ent_local = logit_norm_local = logit_max_local = torch.zeros(
