...
@triton.autotune(
    configs=[
        ...
        # Configurations with V_BLOCK_SIZE = 128, GROUP_SIZE = 64
        ...
        # Configurations with V_BLOCK_SIZE = 256, GROUP_SIZE = 32
        triton.Config({"V_BLOCK_SIZE": 256, "N_BLOCK_SIZE": 128, "H_BLOCK_SIZE": 128, "GROUP_SIZE": 32}, num_warps=4),
        triton.Config(
        ...
        triton.Config(
            {"V_BLOCK_SIZE": 256, "N_BLOCK_SIZE": 128, "H_BLOCK_SIZE": 128, "GROUP_SIZE": 32}, num_warps=8, num_stages=3
        ),
        triton.Config(
            {"V_BLOCK_SIZE": 256, "N_BLOCK_SIZE": 128, "H_BLOCK_SIZE": 128, "GROUP_SIZE": 32}, num_warps=8, num_stages=4
        ),
        triton.Config({"V_BLOCK_SIZE": 256, "N_BLOCK_SIZE": 128, "H_BLOCK_SIZE": 256, "GROUP_SIZE": 32}, num_warps=4),
        triton.Config(
            {"V_BLOCK_SIZE": 256, "N_BLOCK_SIZE": 128, "H_BLOCK_SIZE": 256, "GROUP_SIZE": 32}, num_warps=4, num_stages=3
        ),
        triton.Config({"V_BLOCK_SIZE": 256, "N_BLOCK_SIZE": 128, "H_BLOCK_SIZE": 256, "GROUP_SIZE": 32}, num_warps=8),
        triton.Config(
