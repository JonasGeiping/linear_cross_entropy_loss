...
@triton.autotune(
    configs=[
        ...
        # #
        triton.Config(
            {"V_BLOCK_SIZE": 256, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 1, "GROUP_SIZE": 32}, num_warps=4
        ),
        triton.Config(
            {"V_BLOCK_SIZE": 256, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 1, "GROUP_SIZE": 32}, num_warps=8
        ),
        triton.Config(
            {"V_BLOCK_SIZE": 256, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 1, "GROUP_SIZE": 32}, num_warps=16
        ),
        triton.Config(
            {"V_BLOCK_SIZE": 256, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 2, "GROUP_SIZE": 32}, num_warps=4
        ),
        triton.Config(
            {"V_BLOCK_SIZE": 256, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 2, "GROUP_SIZE": 32}, num_warps=8
        ),
        triton.Config(
            {"V_BLOCK_SIZE": 256, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 2, "GROUP_SIZE": 32}, num_warps=16
        ),
        triton.Config(
            {"V_BLOCK_SIZE": 256, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 4, "GROUP_SIZE": 32}, num_warps=4
        ),
        triton.Config(
            {"V_BLOCK_SIZE": 256, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 4, "GROUP_SIZE": 32}, num_warps=8
        ),
        triton.Config(
            {"V_BLOCK_SIZE": 256, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 4, "GROUP_SIZE": 32}, num_warps=16
        ),
        #
        triton.Config(
            {"V_BLOCK_SIZE": 256, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 1, "GROUP_SIZE": 32}, num_warps=4
        ...
        #
        triton.Config(
            {"V_BLOCK_SIZE": 128, "N_BLOCK_SIZE": 128, "H_BLOCK_SIZE": 128, "V_TILES": 1, "GROUP_SIZE": 32}, num_warps=4
        ),
        triton.Config(
            {"V_BLOCK_SIZE": 128, "N_BLOCK_SIZE": 128, "H_BLOCK_SIZE": 128, "V_TILES": 1, "GROUP_SIZE": 32}, num_warps=8
        ),
        triton.Config(
            {"V_BLOCK_SIZE": 128, "N_BLOCK_SIZE": 128, "H_BLOCK_SIZE": 128, "V_TILES": 1, "GROUP_SIZE": 32},
            num_warps=16,
        ),
        triton.Config(
            {"V_BLOCK_SIZE": 128, "N_BLOCK_SIZE": 128, "H_BLOCK_SIZE": 128, "V_TILES": 2, "GROUP_SIZE": 32}, num_warps=4
        ),
        triton.Config(
            {"V_BLOCK_SIZE": 128, "N_BLOCK_SIZE": 128, "H_BLOCK_SIZE": 128, "V_TILES": 2, "GROUP_SIZE": 32}, num_warps=8
        ),
        triton.Config(
            {"V_BLOCK_SIZE": 128, "N_BLOCK_SIZE": 128, "H_BLOCK_SIZE": 128, "V_TILES": 2, "GROUP_SIZE": 32},
            num_warps=16,
        ),
        triton.Config(
            {"V_BLOCK_SIZE": 128, "N_BLOCK_SIZE": 128, "H_BLOCK_SIZE": 128, "V_TILES": 4, "GROUP_SIZE": 32}, num_warps=4
        ),
        triton.Config(
            {"V_BLOCK_SIZE": 128, "N_BLOCK_SIZE": 128, "H_BLOCK_SIZE": 128, "V_TILES": 4, "GROUP_SIZE": 32}, num_warps=8
        ),
        triton.Config(
            {"V_BLOCK_SIZE": 128, "N_BLOCK_SIZE": 128, "H_BLOCK_SIZE": 128, "V_TILES": 4, "GROUP_SIZE": 32},
            num_warps=16,
        ),
        #
        triton.Config(
            {"V_BLOCK_SIZE": 256, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 1, "GROUP_SIZE": 64}, num_warps=4
        ),
        triton.Config(
            {"V_BLOCK_SIZE": 256, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 1, "GROUP_SIZE": 64}, num_warps=8
        ),
        triton.Config(
            {"V_BLOCK_SIZE": 256, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 1, "GROUP_SIZE": 64}, num_warps=16
        ),
        triton.Config(
            {"V_BLOCK_SIZE": 256, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 2, "GROUP_SIZE": 64}, num_warps=4
        ),
        triton.Config(
            {"V_BLOCK_SIZE": 256, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 2, "GROUP_SIZE": 64}, num_warps=8
        ),
        triton.Config(
            {"V_BLOCK_SIZE": 256, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 2, "GROUP_SIZE": 64}, num_warps=16
        ),
        triton.Config(
            {"V_BLOCK_SIZE": 256, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 4, "GROUP_SIZE": 64}, num_warps=4
        ),
        triton.Config(
            {"V_BLOCK_SIZE": 256, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 4, "GROUP_SIZE": 64}, num_warps=8
        ),
        triton.Config(
            {"V_BLOCK_SIZE": 256, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 4, "GROUP_SIZE": 64}, num_warps=16
        ),
    ],
    key=["V", "N", "H"],
