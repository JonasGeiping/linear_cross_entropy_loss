...
class LinearCrossEntropyLoss(torch.autograd.Function):
    ...
    def forward(
        ...
        for idx_N_group, x_n_chunk in enumerate(x.split(N_group)):
            ...
            # if x.requires_grad:
            #     x_grad[N_group * idx_N_group : x_n_chunk.shape[0] * (idx_N_group + 1)] = z_grad @ At.detach().T
...
if __name__ == "__main__":
    ...
    torch.compile(linear_cross_entropy, fullgraph=True, mode="max-autotune")(x, y, At)
