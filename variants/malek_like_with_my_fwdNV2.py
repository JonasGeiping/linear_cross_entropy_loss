...
@triton.autotune(
    configs=[
        ...
        triton.Config({"V_BLOCK_SIZE": 512, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 1}, num_warps=32),
        triton.Config(
            {"V_BLOCK_SIZE": 512, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 1}, num_warps=8, num_stages=4
        ),
        triton.Config(
            {"V_BLOCK_SIZE": 512, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 1}, num_warps=8, num_stages=5
        ),
        triton.Config(
            {"V_BLOCK_SIZE": 512, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 1}, num_warps=8, num_stages=6
        ),
        #
        # triton.Config({"V_BLOCK_SIZE": 64, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 1, "GROUP_SIZE": 4}),
        # triton.Config({"V_BLOCK_SIZE": 128, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 1, "GROUP_SIZE": 4}),
        # triton.Config({"V_BLOCK_SIZE": 256, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 1, "GROUP_SIZE": 4}),
        # triton.Config({"V_BLOCK_SIZE": 512, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 1, "GROUP_SIZE": 4}),
        # triton.Config({"V_BLOCK_SIZE": 64, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 1, "GROUP_SIZE": 4}),
        # triton.Config({"V_BLOCK_SIZE": 256, "N_BLOCK_SIZE": 16, "H_BLOCK_SIZE": 256, "V_TILES": 1, "GROUP_SIZE": 4}),
        # triton.Config({"V_BLOCK_SIZE": 512, "N_BLOCK_SIZE": 16, "H_BLOCK_SIZE": 16, "V_TILES": 1, "GROUP_SIZE": 4}),
        # triton.Config({"V_BLOCK_SIZE": 256, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 128, "V_TILES": 1, "GROUP_SIZE": 4}),
        # triton.Config(
        #     {"V_BLOCK_SIZE": 64, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 1, "GROUP_SIZE": 4}, num_warps=4
        # ),
        # triton.Config(
        #     {"V_BLOCK_SIZE": 128, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 1, "GROUP_SIZE": 4}, num_warps=4
        # ),
        # triton.Config(
        #     {"V_BLOCK_SIZE": 256, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 1, "GROUP_SIZE": 4}, num_warps=4
        # ),
        # triton.Config(
        #     {"V_BLOCK_SIZE": 512, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 1, "GROUP_SIZE": 4}, num_warps=4
        # ),
        # triton.Config(
        #     {"V_BLOCK_SIZE": 64, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 1, "GROUP_SIZE": 4}, num_warps=4
        # ),
        # triton.Config(
        #     {"V_BLOCK_SIZE": 256, "N_BLOCK_SIZE": 16, "H_BLOCK_SIZE": 256, "V_TILES": 1, "GROUP_SIZE": 4}, num_warps=4
        # ),
        # triton.Config(
        #     {"V_BLOCK_SIZE": 512, "N_BLOCK_SIZE": 16, "H_BLOCK_SIZE": 16, "V_TILES": 1, "GROUP_SIZE": 4}, num_warps=4
        # ),
        # triton.Config(
        #     {"V_BLOCK_SIZE": 256, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 128, "V_TILES": 1, "GROUP_SIZE": 4}, num_warps=4
        # ),
        # triton.Config(
        #     {"V_BLOCK_SIZE": 64, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 1, "GROUP_SIZE": 4}, num_warps=8
        # ),
        # triton.Config(
        #     {"V_BLOCK_SIZE": 128, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 1, "GROUP_SIZE": 4}, num_warps=8
        # ),
        # triton.Config(
        #     {"V_BLOCK_SIZE": 256, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 1, "GROUP_SIZE": 4}, num_warps=8
        # ),
        # triton.Config(
        #     {"V_BLOCK_SIZE": 64, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 1, "GROUP_SIZE": 4}, num_warps=8
        # ),
        # triton.Config(
        #     {"V_BLOCK_SIZE": 256, "N_BLOCK_SIZE": 16, "H_BLOCK_SIZE": 256, "V_TILES": 1, "GROUP_SIZE": 4}, num_warps=8
        # ),
        # triton.Config(
        #     {"V_BLOCK_SIZE": 512, "N_BLOCK_SIZE": 16, "H_BLOCK_SIZE": 16, "V_TILES": 1, "GROUP_SIZE": 4}, num_warps=8
        # ),
        # triton.Config(
        #     {"V_BLOCK_SIZE": 256, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 128, "V_TILES": 1, "GROUP_SIZE": 4}, num_warps=8
        # ),
        # triton.Config(
        #     {"V_BLOCK_SIZE": 512, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 1, "GROUP_SIZE": 4}, num_warps=8
        # ),
        # #
        # triton.Config({"V_BLOCK_SIZE": 64, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 1, "GROUP_SIZE": 8}),
        # triton.Config({"V_BLOCK_SIZE": 128, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 1, "GROUP_SIZE": 8}),
        # triton.Config({"V_BLOCK_SIZE": 256, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 1, "GROUP_SIZE": 8}),
        # triton.Config({"V_BLOCK_SIZE": 512, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 1, "GROUP_SIZE": 8}),
        # triton.Config({"V_BLOCK_SIZE": 64, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 1, "GROUP_SIZE": 8}),
        # triton.Config({"V_BLOCK_SIZE": 256, "N_BLOCK_SIZE": 16, "H_BLOCK_SIZE": 256, "V_TILES": 1, "GROUP_SIZE": 8}),
        # triton.Config({"V_BLOCK_SIZE": 512, "N_BLOCK_SIZE": 16, "H_BLOCK_SIZE": 16, "V_TILES": 1, "GROUP_SIZE": 8}),
        # triton.Config({"V_BLOCK_SIZE": 256, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 128, "V_TILES": 1, "GROUP_SIZE": 8}),
        # triton.Config(
        #     {"V_BLOCK_SIZE": 64, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 1, "GROUP_SIZE": 8}, num_warps=4
        # ),
        # triton.Config(
        #     {"V_BLOCK_SIZE": 128, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 1, "GROUP_SIZE": 8}, num_warps=4
        # ),
        # triton.Config(
        #     {"V_BLOCK_SIZE": 256, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 1, "GROUP_SIZE": 8}, num_warps=4
        # ),
        # triton.Config(
        #     {"V_BLOCK_SIZE": 512, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 1, "GROUP_SIZE": 8}, num_warps=4
        # ),
        # triton.Config(
        #     {"V_BLOCK_SIZE": 64, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 1, "GROUP_SIZE": 8}, num_warps=4
        # ),
        # triton.Config(
        #     {"V_BLOCK_SIZE": 256, "N_BLOCK_SIZE": 16, "H_BLOCK_SIZE": 256, "V_TILES": 1, "GROUP_SIZE": 8}, num_warps=4
        # ),
        # triton.Config(
        #     {"V_BLOCK_SIZE": 512, "N_BLOCK_SIZE": 16, "H_BLOCK_SIZE": 16, "V_TILES": 1, "GROUP_SIZE": 8}, num_warps=4
        # ),
        # triton.Config(
        #     {"V_BLOCK_SIZE": 256, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 128, "V_TILES": 1, "GROUP_SIZE": 8}, num_warps=4
        # ),
        # triton.Config(
        #     {"V_BLOCK_SIZE": 64, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 1, "GROUP_SIZE": 8}, num_warps=8
        # ),
        # triton.Config(
        #     {"V_BLOCK_SIZE": 128, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 1, "GROUP_SIZE": 8}, num_warps=8
        # ),
        # triton.Config(
        #     {"V_BLOCK_SIZE": 256, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 1, "GROUP_SIZE": 8}, num_warps=8
        # ),
        # triton.Config(
        #     {"V_BLOCK_SIZE": 64, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 1, "GROUP_SIZE": 8}, num_warps=8
        # ),
        # triton.Config(
        #     {"V_BLOCK_SIZE": 256, "N_BLOCK_SIZE": 16, "H_BLOCK_SIZE": 256, "V_TILES": 1, "GROUP_SIZE": 8}, num_warps=8
        # ),
        # triton.Config(
        #     {"V_BLOCK_SIZE": 512, "N_BLOCK_SIZE": 16, "H_BLOCK_SIZE": 16, "V_TILES": 1, "GROUP_SIZE": 8}, num_warps=8
        # ),
        # triton.Config(
        #     {"V_BLOCK_SIZE": 256, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 128, "V_TILES": 1, "GROUP_SIZE": 8}, num_warps=8
        # ),
        # triton.Config(
        #     {"V_BLOCK_SIZE": 512, "N_BLOCK_SIZE": 64, "H_BLOCK_SIZE": 64, "V_TILES": 1, "GROUP_SIZE": 8}, num_warps=8
        # ),
    ],
    key=["V", "N", "H"],
...
class LinearCrossEntropyLoss(torch.autograd.Function):
    ...
    def forward(
        ...
        # if linear_xent_fwd_prep_bwd_kernel_matmul_t.best_config.kwargs["V_TILES"] > 1:
